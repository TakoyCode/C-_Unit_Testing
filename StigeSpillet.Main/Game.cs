namespace StigeSpilletTDD.Main
{
    public class Game
    {
        ...
        {
            // returnerer den første stiggen som har posisjonen vi søker etter
            // ser ut som den ligner mye på find() fra JS
            return _ladders.FirstOrDefault(ladder => ladder.PositionFrom == pos);
        }
